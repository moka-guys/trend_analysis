...
tool_settings = {
    ...
    "properly_paired": {
        ...
        "plot_text": "The percentage of QC-passed reads that were properly paired. Properly paired = both mates of a read pair map to the same chromosome, oriented towards one another, with a sensible insert size. Note, the negative control is NOT included in this plot",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
    ...
    "pct_off_amplicon": {
        ...
        "plot_text": "The percentage of aligned passing filter (PF) bases that mapped neither on or near an amplicon. This is a measure of primer specificity. Note, the negative control is  NOT included in this plot",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
