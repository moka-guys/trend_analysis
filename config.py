...
tool_settings = {
    "run_names": {
        ...
        "plot_text": "These are the runs included on the below plots. Numbers are used to simplify the x axis labels on the plots, so this table can be used to link the axis labels to run name. Outliers are displayed as circles, median as orange line, IQR as box",
    ...
    "picard_insertsize": {
        ...
        "plot_text": "Boxplots showing the range and spread of insert sizes. This will highlight DNA fragmentation. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
        "upper_lim": False,
        "upper_lim_label": "Minimum insert size cut-off",
        "lower_lim": 150,
        "lower_lim_label": False,
        "WES": True,
        "PANEL": True,
    ...
    "q30_percent": {
        ...
        "plot_text": "Boxplots showing the percentage of bases >= Q30. Values within each boxplot are for each lane.\n This shows how well the base calling has performed on the sequencer. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
    ...
    "target_bases_at_30X": {
        ...
        "plot_text": "Boxplot showing the % of bases in the target regions which are covered at >= 30X. Outliers are displayed as circles, median as orange line, IQR as box",
    ...
    "target_bases_at_20X": {
        ...
        "plot_text": "Boxplot showing the % of bases in the target regions which are covered at >= 20X.\nSamples below 90% are failed. Samples above 95% pass. Samples between 90-95% may be analysed with caution. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "dashed",
        "lower_lim_linestyle": "solid",
        "lower_lim_linecolour": 'r',
        "upper_lim_linecolour": 'k',
    ...
    "on_target_vs_selected": {
        ...
        "plot_text": "The % of on and near bait bases that are on as opposed to near (as defined by the BED file containing the capture regions). Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
    ...
    "contamination": {
        ...
        "plot_text": "The contamination estimate as calculated by VerifyBAMID (FREEMIX). A sample is considered contaminated when FREEMIX > 0.03. Outliers are displayed as circles, median as orange line, IQR as box",
        "lower_lim_linestyle": "",
    ...
    "cluster_density_MiSeq": {
        ...
        "plot_text": "MiSeq sequencing run per-lane cluster density. Cluster density in thousands (K) of clusters per mm2 of flowcell area for each sequencing lane. Optimal density for MiSeq is 1200-1400 K/mm2. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "solid",
        "lower_lim_linestyle": "solid",
    ...
    "cluster_density_NextSeq": {
        ...
        "plot_text": "NextSeq sequencing run per-lane cluster density. Cluster density in thousands (K) of clusters per mm2 of flowcell area for each sequencing lane. Optimal density for NextSeq is 170-230 K/mm2. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "solid",
        "lower_lim_linestyle": "solid",
        "lower_lim_linecolour": 'b',
        "upper_lim_linecolour": 'r',
    ...
    "properly_paired": {
        ...
        "plot_text": "The percentage of QC-passed reads that were properly paired. Properly paired = both mates of a read pair map to the same chromosome, oriented towards one another, with a sensible insert size. Note, the negative control is NOT included in this plot. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
    ...
    "pct_off_amplicon": {
        ...
        "plot_text": "The percentage of aligned passing filter (PF) bases that mapped neither on or near an amplicon. This is a measure of primer specificity. Note, the negative control is  NOT included in this plot. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
    ...
    "fastq_total_sequences": {
        ...
        "plot_text": "Boxplot showing the total number of sequences. Outliers are displayed as circles, median as orange line, IQR as box",
        "upper_lim_linestyle": "",
        "lower_lim_linestyle": "",
        "lower_lim_linecolour": "",
        "upper_lim_linecolour": "",
